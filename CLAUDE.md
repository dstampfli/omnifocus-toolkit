...
- `omnifocus_common.py` holds task-enrichment helpers (`clean_note`, `media_type_for`, `attachment_block`, `build_task_content`, `run_jxa`, `fetch_attachment_b64`) shared by the triage script and a planned future task-reviewer feature.
